...
void lowestValue(int one[], int two[], int three[], int arraySize) {
    int lowest1 = one[0], lowest2 = two[0], lowest3 = three[0];
    ...
    int greatestOfLowest = lowest1;
    if (greatestOfLowest > lowest2) {
        greatestOfLowest = lowest2;
    }
    if (greatestOfLowest > lowest3) {
        greatestOfLowest = lowest3;
    }

    cout << "low in 1st array == " << fixed << setprecision(1) << lowest1 << endl;
    cout << "low in 2nd array == " << fixed << setprecision(1) << lowest2 << endl;
    cout << "low in 3rd array == " << fixed << setprecision(1) << lowest3 << endl << endl;

    cout << "lowest value == " << greatestOfLowest << endl;
}
