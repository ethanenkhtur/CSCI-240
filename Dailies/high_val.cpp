...
void highestValue(float one[], float two[], float three[], int arraySize) {
    float greatest1 = one[0], greatest2 = two[0], greatest3 = three[0];
    ...
    for (int i = 0; i < arraySize; i++) {
        if (greatest3 < three[i]) {
            greatest3 = three[i];
        }
    }

    cout << "high in 1st array == " << fixed << setprecision(1) << greatest1 << endl;
    cout << "high in 2nd array == " << fixed << setprecision(1) << greatest2 << endl;
    cout << "high in 3rd array == " << fixed << setprecision(1) << greatest3 << endl;
}